...
- Name: access-control.spec.ts >> protected areas redirect to login
- Location: e2e/access-control.spec.ts:53:5
...
Received string:  "http://localhost:3100/coming-soon"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en" dir="ltr" class="figtree_a011e6ba-module__HhqV1q__variable inter_8e47ce46-module__UqgS-W__variable dark">…</html>
       - unexpected value "http://localhost:3100/coming-soon"
