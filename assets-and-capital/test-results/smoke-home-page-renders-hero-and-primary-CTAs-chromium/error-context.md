...
- Name: smoke.spec.ts >> home page renders hero and primary CTAs
...
Locator: getByRole('link', { name: /i'?m an investor/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /i'?m an investor/i })
