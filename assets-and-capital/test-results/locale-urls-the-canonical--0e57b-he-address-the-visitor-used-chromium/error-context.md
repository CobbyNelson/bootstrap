...
- Name: locale-urls.spec.ts >> the canonical URL is the address the visitor used
- Location: e2e/locale-urls.spec.ts:46:5

# Error details

```
Error: /about canonical

expect(received).toContain(expected) // indexOf

Expected substring: "<https://assetsandcapitalltd.com/about>; rel=\"canonical\""
Received string:    ""
```
