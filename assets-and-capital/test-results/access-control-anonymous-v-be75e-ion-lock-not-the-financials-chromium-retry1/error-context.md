...
- Name: access-control.spec.ts >> anonymous visitors see the subscription lock, not the financials
- Location: e2e/access-control.spec.ts:23:5
...
Locator: getByText(/investor subscription feature/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/investor subscription feature/i)
