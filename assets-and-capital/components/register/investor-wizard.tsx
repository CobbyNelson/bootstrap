    ...
    <div className="container-x grid gap-10 py-12 lg:grid-cols-[260px_1fr] md:py-16">
      ...
      <aside className="lg:sticky lg:top-24 lg:self-start">
        ...
        <ol className="mt-6 space-y-1">
          <li className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-ink/50">
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  state === "now" ? "bg-brand-50 font-medium text-ink" : "text-ink/50"
                )}
              >
                <span
                  className={cn(
                    ...
                    state === "todo" && "border border-ink/20 text-ink/40"
                  )}
                >
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <span
              className={cn(
                ...
                saved ? "bg-emerald-50 text-emerald-600 opacity-100" : "text-ink/30 opacity-0"
              )}
            >
...
function FieldControl({
  ...
  return (
    <div className={wrap}>
      ...
      {field.help && <p className="mt-1 text-xs text-ink/40">{field.help}</p>}
  ...
  return (
    <div className="mt-7">
      <div className="space-y-6">
        {fieldSteps.map((s) => (
          <div key={s.id}>
            <p className="text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-ink/40">{s.title}</p>
