  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand-700">Video meetings</p>
          ...
          {MEETINGS.filter((m) => m.status !== "Live").map((m) => (
            <div key={m.id} className="flex items-center gap-4 rounded-2xl border border-ink/[0.07] bg-white p-4">
              <div className="grid h-14 w-14 flex-none place-items-center rounded-2xl bg-paper-2 text-center">
                <span className="text-[0.6rem] font-medium uppercase text-ink/60">{m.date.split(" ")[0]}</span>
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-xs text-ink/65">{m.with}</p>
        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-ink/[0.07] bg-white p-5">
            ...
            <label className="mt-4 block">
              <span className="text-xs font-medium text-ink/65">Date</span>
              <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-ink/10 bg-paper-2/40 px-3.5 py-2.5 text-sm text-ink">
                <Calendar className="h-4 w-4 text-ink/60" /> Thursday, 24 Jul 2026
              </div>
            </label>
            <div className="mt-4">
              <span className="text-xs font-medium text-ink/65">Available slots (GMT)</span>
            ...
            <div className="mt-4">
              <span className="text-xs font-medium text-ink/65">Platform</span>
            ...
            <div className="mt-3 space-y-2.5">
              {[
                ...
                <div key={c.name} className="flex items-center gap-3">
                  <span className="grid h-8 w-8 flex-none place-items-center rounded-lg bg-ink/[0.05] text-ink/65"><Link2 className="h-4 w-4" /></span>
