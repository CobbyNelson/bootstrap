...
const MORE: Opportunity[] = [
  ...
  { name: "Coastal Wind Partners", sector: "Renewable Energy", country: "South Africa", region: "Southern Africa", stage: "Growth", instrument: "Equity", ask: "$48M", targetReturn: "18% IRR", match: 85, tier: "Gold", blurb: "300MW onshore wind pipeline with signed power-purchase agreements.", image: "/img/sector-wind.webp" },
