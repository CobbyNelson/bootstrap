...
const fr: Dict = {
  labels: {
    ...
    "Buyout": "Rachat",
    "Mature": "Mature",
    "Green field": "Création",
    "Brown field": "Reprise de site",
    "Equity": "Capitaux propres",
    "Equity + Debt": "Capitaux propres + dette",
...
const es: Dict = {
  labels: {
    ...
    "Growth": "Crecimiento",
    "Series A": "Serie A",
    "Buyout": "Compra apalancada",
    "Mature": "Madura",
    "Green field": "Nueva planta",
    "Brown field": "Planta existente",
    "Equity": "Capital",
    "Equity + Debt": "Capital + deuda",
    "Preferred Equity": "Acciones preferentes",
    "Debt": "Deuda",
...
const ar: Dict = {
  labels: {
    ...
    "Buyout": "استحواذ",
    "Mature": "ناضجة",
    "Green field": "مشروع جديد",
    "Brown field": "مشروع قائم",
    "Equity": "حقوق ملكية",
    "Equity + Debt": "حقوق ملكية ودين",
    "Preferred Equity": "أسهم ممتازة",
    "Debt": "دين",
    "East Africa": "شرق أفريقيا",
    "West Africa": "غرب أفريقيا",
    "North Africa": "شمال أفريقيا",
    "Southern Africa": "الجنوب الأفريقي",
    "Invest": "استثمر",
