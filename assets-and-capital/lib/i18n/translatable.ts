...
export const TRANSLATABLE: { source: string; context: string }[] = [
  ...
  { source: "Continue with {provider}", context: "Checkout" },
  { source: "Expiry", context: "Checkout" },
  { source: "MM / YY", context: "Checkout" },
  { source: "Name on card", context: "Checkout" },
  { source: "No real charge. Card {ok} approves; {bad} declines. Any future expiry & CVC.", context: "Checkout" },
  ...
  { source: "Are opportunities screened before I see them?", context: "FAQ page" },
  { source: "Browsing and mandate matching are free for investors. Success and advisory fees apply on completed transactions and premium services, disclosed up front.", context: "FAQ page" },
  { source: "Complete the guided intake — your business profile, financials, the raise and supporting documents. Our team reviews and verifies your listing, then it becomes discoverable to mandate-matched investors.", context: "FAQ page" },
  { source: "Contact us", context: "FAQ page" },
  { source: "Data is encrypted in transit and at rest, access is role-based, and every data-room action is logged. We run KYC/AML and sanctions screening on all parties.", context: "FAQ page" },
  { source: "Do you support digital signatures?", context: "FAQ page" },
  ...
  { source: "How do I list my business?", context: "FAQ page" },
  { source: "How do I run due diligence?", context: "FAQ page" },
  { source: "How does mandate matching work?", context: "FAQ page" },
  { source: "How is my data protected?", context: "FAQ page" },
  { source: "How long does a raise take?", context: "FAQ page" },
  { source: "Is there a fee to invest?", context: "FAQ page" },
  { source: "It varies by sector, stage and readiness, but a disciplined, verified listing with a complete data room typically moves through the pipeline far faster than an unstructured process.", context: "FAQ page" },
  { source: "Listings are tiered (Standard to Platinum) with a success-fee model on capital raised. See the pricing page for the full breakdown.", context: "FAQ page" },
  { source: "Our team is happy to help you get set up, whether you're deploying capital or raising it.", context: "FAQ page" },
  { source: "Questions, answered", context: "FAQ page" },
  { source: "Security & compliance", context: "FAQ page" },
  { source: "Still have questions?", context: "FAQ page" },
  { source: "Verified investors get access to secure, permissioned data rooms with document watermarking and a full activity audit trail, plus messaging and scheduled calls with the business.", context: "FAQ page" },
  { source: "What does a listing cost?", context: "FAQ page" },
  { source: "Who sees my information?", context: "FAQ page" },
  { source: "Yes — NDAs, term sheets and agreements can be signed electronically with a tamper-evident certificate of completion and audit trail.", context: "FAQ page" },
  { source: "Yes. Every business is screened and verified — registration, financials, licensing and references — before it reaches the marketplace. Each listing carries a verification badge and a business readiness score.", context: "FAQ page" },
  { source: "You build an investment mandate — objectives, ticket size, sectors, geographies, risk and instrument preferences. Our engine scores every vetted opportunity against 15 weighted criteria and surfaces the strongest fits with an explainable match score.", context: "FAQ page" },
  { source: "Your teaser is visible to verified investors; sensitive materials sit behind an NDA-gated data room you control. You approve who gets access and can revoke it at any time.", context: "FAQ page" },
  ...
  { source: "Agriculture", context: "Industries" },
  ...
  { source: "Communications", context: "Industries" },
  { source: "Consumer", context: "Industries" },
  { source: "EdTech, training services, corporate learning", context: "Industries" },
  { source: "Education", context: "Industries" },
  { source: "Energy", context: "Industries" },
  { source: "Farming, agri-tech, food processing & distribution", context: "Industries" },
  { source: "Financial Services", context: "Industries" },
  { source: "FMCG, retail chains, luxury, food & beverage", context: "Industries" },
  { source: "Healthcare", context: "Industries" },
  { source: "Hospitality", context: "Industries" },
  { source: "Hotels, resorts, airlines, travel services", context: "Industries" },
  { source: "Industrials", context: "Industries" },
  { source: "Information Technology", context: "Industries" },
  { source: "Infrastructure", context: "Industries" },
  { source: "Logistics, machinery, aerospace, automotive, supply chain", context: "Industries" },
  { source: "Materials", context: "Industries" },
  ...
  { source: "Real Estate", context: "Industries" },
  ...
  { source: "Featured · {category}", context: "Insights" },
  ...
  { source: "Identity and transaction records — retained after the relationship ends because anti-money-laundering law requires it.", context: "Legal — Privacy Policy" },
  ...
  { source: "Our servers are located in Europe. Where a provider processes data outside your country, we rely on appropriate safeguards such as the UK/EU standard contractual clauses.", context: "Legal — Privacy Policy" },
  ...
  { source: "Security and audit logs — 12 months.", context: "Legal — Privacy Policy" },
  ...
  { source: "We do not sell personal data. We share it only with providers who process it on our instructions — hosting and infrastructure, payment processing, identity verification, and email delivery — and with regulators, auditors or law enforcement where we are legally required to.", context: "Legal — Privacy Policy" },
  ...
  { source: "Businesses pay listing fees and a success fee on capital raised through the platform. Investors register free and pay only for requested roadshows and partnerships created at their request.", context: "Legal — Terms of Service" },
  ...
  { source: "(on behalf of {business}) and you, the receiving investor.", context: "Marketplace" },
  { source: "{n} weighted criteria", context: "Marketplace" },
  { source: "{name} is seeking {ask} in {instrument} to accelerate growth across {region}. The opportunity has been screened and verified by the Assets & Capital team.", context: "Marketplace" },
  { source: "{tier} listing", context: "Marketplace" },
  ...
  { source: "Compare", context: "Marketplace" },
  { source: "Compare opportunities", context: "Marketplace" },
  ...
  { source: "Documents are released once you've signed the non-disclosure agreement for {business}.", context: "Marketplace" },
  ...
  { source: "I have read and agree to the terms of this NDA for {business}.", context: "Marketplace" },
  { source: "Instrument", context: "Marketplace" },
  { source: "Interest expressed", context: "Marketplace" },
  { source: "Investment readiness", context: "Marketplace" },
  { source: "List view", context: "Marketplace" },
  { source: "Listing tier", context: "Marketplace" },
  { source: "Location", context: "Marketplace" },
  { source: "Locked", context: "Marketplace" },
  { source: "Mandate match", context: "Marketplace" },
  ...
  { source: "opportunities.", context: "Marketplace" },
  { source: "Opportunity", context: "Marketplace" },
  { source: "Overview", context: "Marketplace" },
  { source: "Pick at least two to compare", context: "Marketplace" },
  ...
  { source: "Save opportunities from the marketplace, then compare your shortlist here.", context: "Marketplace" },
  ...
  { source: "Sector", context: "Marketplace" },
  ...
  { source: "Stage", context: "Marketplace" },
  ...
  { source: "Subscribe to see full financials, target returns, estimated revenue & EBITDA, risk level and compliance readiness for every listing.", context: "Marketplace" },
  ...
  { source: "View", context: "Marketplace" },
  { source: "vs. mandate: {mandate}", context: "Marketplace" },
  { source: "Weigh mandate fit, terms and fundamentals side by side.", context: "Marketplace" },
  ...
  { source: "{domain} · Capital-raising & deal-making platform.", context: "Navigation & footer" },
  { source: "© {year} {company}. All rights reserved.", context: "Navigation & footer" },
  ...
  { source: "We connect vetted businesses with a global network of ready investors — for capital raising, partnerships, and market expansion.", context: "Navigation & footer" },
  { source: "We use cookies that are necessary to run the platform. With your permission we would also measure how it is used. See our {policy}.", context: "Navigation & footer" },
  ...
  { source: "A specialised roadshow puts your opportunity in front of several pre-screened investors whose mandates match it, organised end to end by our team.", context: "Pricing page" },
  ...
  { source: "Can I upgrade my listing later?", context: "Pricing page" },
  { source: "Choose {tier}", context: "Pricing page" },
  { source: "Do investors pay to join?", context: "Pricing page" },
  { source: "For businesses raising capital, the success fee is charged only when a deal closes through the platform. If the raise does not complete, there is no fee.", context: "Pricing page" },
  ...
  { source: "How does the success fee work?", context: "Pricing page" },
  ...
  { source: "What's included in a roadshow?", context: "Pricing page" },
  { source: "Yes. You can upgrade from Standard to Silver, Gold, or Platinum at any time and only pay the difference for the remainder of your listing window.", context: "Pricing page" },
  ...
  { source: "Already have an account?", context: "Registration" },
  ...
  { source: "Build my mandate", context: "Registration" },
  ...
  { source: "Buyouts, growth, venture, secondaries and distressed.", context: "Registration" },
  ...
  { source: "Direct property, funds, joint ventures and co-investment.", context: "Registration" },
  ...
  { source: "First-hand deal notifications", context: "Registration" },
  { source: "Founders & key contacts (with roles)", context: "Registration" },
  { source: "Free to register", context: "Registration" },
  ...
  { source: "List my business", context: "Registration" },
  ...
  { source: "Mandate-based matching", context: "Registration" },
  ...
  { source: "Mutual, hedge, private, UCITS, ETFs and multi-asset.", context: "Registration" },
  ...
  { source: "Success-fee aligned", context: "Registration" },
  ...
  { source: "Tiered listings", context: "Registration" },
  ...
  { source: "No results for “{query}”.", context: "Search" },
  ...
  { source: "A plan earns the meeting when it answers the obvious questions before they are asked. We write yours to set out the market, substantiate the ask, and address what diligence will raise.", context: "Services" },
  { source: "A teaser and deck written to earn the second meeting.", context: "Services" },
  { source: "Agendas built around your stated criteria", context: "Services" },
  { source: "Aligned to what investors read first", context: "Services" },
  { source: "Business plan writing", context: "Services" },
  { source: "Clear articulation of the ask and use of funds", context: "Services" },
  { source: "Clear, auditable assumptions", context: "Services" },
  { source: "Concise, high-impact teaser", context: "Services" },
  { source: "Connect with suppliers, buyers, and partners to grow beyond the initial investment.", context: "Services" },
  ...
  { source: "Follow-up and introductions after the event", context: "Services" },
  { source: "Full investor pitch deck", context: "Services" },
  { source: "Full logistics handled by our team", context: "Services" },
  { source: "Get started", context: "Services" },
  { source: "Growth strategy and milestones", context: "Services" },
  { source: "In-person and virtual formats", context: "Services" },
  { source: "Introductions to suppliers, buyers and partners once the investment is made.", context: "Services" },
  { source: "Investor-ready formatting and design", context: "Services" },
  { source: "Investors will pull your model apart, so it should be built to survive that. We write three-statement models where each assumption is visible, sourced and easy to test against a different view.", context: "Services" },
  { source: "Key metrics presented clearly", context: "Services" },
  { source: "Local events access", context: "Services" },
  { source: "Local partner introductions", context: "Services" },
  { source: "Market access support", context: "Services" },
  { source: "Market and competitive analysis", context: "Services" },
  { source: "Market-entry guidance", context: "Services" },
  { source: "Meet several pre-screened opportunities, or reach targeted investors, in one session.", context: "Services" },
  { source: "Models where every assumption is stated and can be traced back to its source.", context: "Services" },
  { source: "Models where every assumption is stated and sourced.", context: "Services" },
  { source: "Most investors decide whether to read on within a page. We prepare a teaser that states the opportunity plainly, and a deck that holds up when it gets forwarded round the table.", context: "Services" },
  { source: "Narrative and design handled together", context: "Services" },
  { source: "Ongoing relationship support", context: "Services" },
  { source: "Our roadshows put the right people in the same room. For investors, we assemble a slate of pre-screened, mandate-matched opportunities. For businesses, we secure meetings with investors whose mandate fits your raise — organised end to end by our team.", context: "Services" },
  { source: "Plans built around what investors read first: the market, the model, the numbers and the team.", context: "Services" },
  { source: "Plans built around what investors read first.", context: "Services" },
  { source: "Pre-screened, mandate-matched participants", context: "Services" },
  { source: "Regulatory and operational context", context: "Services" },
  { source: "Request a roadshow", context: "Services" },
  { source: "Risk assessment and mitigation", context: "Services" },
  { source: "Scenario and sensitivity analysis", context: "Services" },
  ...
  { source: "Supplier and buyer connections", context: "Services" },
  { source: "Teaser & pitch preparation", context: "Services" },
  { source: "The work continues after the money lands. Our team in-market makes the introductions a new investment needs early: suppliers, buyers, distribution partners and the advisers who know the terrain.", context: "Services" },
  { source: "Three-statement financial models", context: "Services" },
  { source: "Unit economics and cohort analysis", context: "Services" },
  { source: "Valuation support", context: "Services" },
  { source: "{n}% match", context: "Shared interface" },
  { source: "{role}, Assets & Capital", context: "Shared interface" },
  { source: "AI profiles & your personalised match rate", context: "Shared interface" },
  { source: "Alongside the marketplace, our team prepares the documents investors read first and puts the right people in the same room. Each is priced separately and requested as you need it.", context: "Shared interface" },
  { source: "Benchmarks drawn from real transactions, plus new opportunities, once a month.", context: "Shared interface" },
  { source: "Business plans, financial models, teaser and pitch preparation, specialised roadshows and market access support — priced separately and requested as you need them.", context: "Shared interface" },
  ...
  { source: "Concierge deal support", context: "Shared interface" },
  { source: "Core details on every listing", context: "Shared interface" },
  ...
  { source: "English version", context: "Shared interface" },
  { source: "Enter", context: "Shared interface" },
  { source: "Everything in Free", context: "Shared interface" },
  { source: "Everything in Pro", context: "Shared interface" },
  { source: "Express interest to reveal your match rate", context: "Shared interface" },
  { source: "Express interest to unlock data rooms", context: "Shared interface" },
  { source: "Full financials & metrics on every business", context: "Shared interface" },
  ...
  { source: "Insight", context: "Shared interface" },
  { source: "Intelligence for capital and opportunity", context: "Shared interface" },
  ...
  { source: "Last updated {date}.", context: "Shared interface" },
  { source: "Legal", context: "Shared interface" },
  { source: "Market Insights", context: "Shared interface" },
  { source: "Match locked", context: "Shared interface" },
  { source: "Message sent", context: "Shared interface" },
  { source: "More insights", context: "Shared interface" },
  { source: "New to Assets & Capital?", context: "Shared interface" },
  { source: "Newsletter & market insights", context: "Shared interface" },
  ...
  { source: "Priority roadshow access", context: "Shared interface" },
  { source: "Quarterly portfolio review", context: "Shared interface" },
  { source: "Read more", context: "Shared interface" },
  { source: "Remove from saved", context: "Shared interface" },
  { source: "Research, country reports, investment guides, and case studies from the Assets & Capital team — built for allocators and founders operating in Africa and emerging markets.", context: "Shared interface" },
  { source: "Research, country reports, investment guides, white papers, case studies, and interviews on African and emerging-market private capital.", context: "Shared interface" },
  { source: "Save", context: "Shared interface" },
  { source: "Save & shortlist opportunities", context: "Shared interface" },
  ...
  { source: "Service", context: "Shared interface" },
  { source: "Services", context: "Shared interface" },
  { source: "Services that get a deal to the table", context: "Shared interface" },
  { source: "Set your investment mandate", context: "Shared interface" },
  { source: "Signing in…", context: "Shared interface" },
  { source: "Skip to content", context: "Shared interface" },
  { source: "Something went wrong. Please try again.", context: "Shared interface" },
  { source: "Subscribe", context: "Shared interface" },
  ...
  { source: "The Assets & Capital briefing", context: "Shared interface" },
  { source: "This page is provided for convenience. The {link} is the authoritative text and prevails in the event of any discrepancy.", context: "Shared interface" },
  { source: "Unlimited side-by-side compare", context: "Shared interface" },
  { source: "What's included", context: "Shared interface" },
