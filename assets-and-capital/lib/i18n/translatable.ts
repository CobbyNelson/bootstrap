...
export const TRANSLATABLE: { source: string; context: string }[] = [
  ...
  { source: "Deploy with an edge", context: "Home page" },
  ...
  { source: "Raise with confidence", context: "Home page" },
  ...
  { source: "A plan earns the meeting when it answers the obvious questions before they are asked. We write yours to set out the market, substantiate the ask, and address what diligence will raise.", context: "Shared interface" },
  ...
  { source: "Connect with suppliers, buyers, and partners to grow beyond the initial investment.", context: "Shared interface" },
  ...
  { source: "Get started", context: "Shared interface" },
  ...
  { source: "Investors will pull your model apart, so it should be built to survive that. We write three-statement models where each assumption is visible, sourced and easy to test against a different view.", context: "Shared interface" },
  ...
  { source: "Meet several pre-screened opportunities, or reach targeted investors, in one session.", context: "Shared interface" },
  { source: "Message sent", context: "Shared interface" },
  { source: "Models where every assumption is stated and sourced.", context: "Shared interface" },
  { source: "More insights", context: "Shared interface" },
  { source: "Most investors decide whether to read on within a page. We prepare a teaser that states the opportunity plainly, and a deck that holds up when it gets forwarded round the table.", context: "Shared interface" },
  { source: "New to Assets & Capital?", context: "Shared interface" },
  { source: "Other", context: "Shared interface" },
  { source: "Our roadshows put the right people in the same room. For investors, we assemble a slate of pre-screened, mandate-matched opportunities. For businesses, we secure meetings with investors whose mandate fits your raise — organised end to end by our team.", context: "Shared interface" },
  ...
  { source: "Plans built around what investors read first.", context: "Shared interface" },
  ...
  { source: "The work continues after the money lands. Our team in-market makes the introductions a new investment needs early: suppliers, buyers, distribution partners and the advisers who know the terrain.", context: "Shared interface" },
